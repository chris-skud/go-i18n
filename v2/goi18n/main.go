...
The commands are:
	...
	translate 	update translation files with messages any messages that need translation
	merge		merge translated message files into active files
	

Workflow:

	1. Use 'goi18n extract' to create a message file that contains the messages defined in your Go source files.

	2. Use 'goi18n translate' to create message files for translation.

	3. Use 'goi18n merge' to merge translated message files with your existing "active" message files.
